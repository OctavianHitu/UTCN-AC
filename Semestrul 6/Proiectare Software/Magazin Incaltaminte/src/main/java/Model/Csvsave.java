...
public interface Csvsave {
    ...
    default void  savecsv(List<IncaltainteMagazin> Incaltamintemag) throws FileNotFoundException {
        PrintWriter printWriter= new PrintWriter(pathfile);
        StringBuilder stbd = new StringBuilder();


        for (IncaltainteMagazin inc:Incaltamintemag)
        {
            ...
            for(Incaltaminte in: inc.getIncaltamintes())
            {
                ...
                stbd.append(in.getIncaltaminteDisponibila().getGetNumarexemplarevandute());
                stbd.append(",");
